...
public class BookingPane extends BasicPane {
    ...
    private void fillNameList() {
        ...
        for (String name : db.getMovieNames()) {
    ...
    private void fillDateList() {
        ...
        for (String date : db.getDates(currentMovie)) {
        	dateListModel.addElement(date);
        }
    }

    private void fillWhatever() {
        ...
        fields[FREE_SEATS].setText(Integer.toString(p.freeSeats));
    }
    
    private void successfulBooking() {
    	JOptionPane.showMessageDialog((JFrame) SwingUtilities.getRoot(this),
    		    "Your ticket has been booked.", "Great Succes", JOptionPane.INFORMATION_MESSAGE);
    }
    private void failedBooking() {
    	JOptionPane.showMessageDialog((JFrame) SwingUtilities.getRoot(this),
    		    "Booking failed. Performance sold out.", "You Done Fucked up:" , JOptionPane.ERROR_MESSAGE);
    }
    ...
    class NameSelectionListener implements ListSelectionListener {
        ...
        public void valueChanged(ListSelectionEvent e) {
            ...
            //String movieName = nameList.getSelectedValue();
            currentMovie = nameList.getSelectedValue();
            fillDateList();
    ...
    class ActionHandler implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (!db.bookTicket(movieName,date)) {
            	System.err.println("No tickets left!!");
            	failedBooking();
            } else {
            	fillWhatever();
            	successfulBooking();
